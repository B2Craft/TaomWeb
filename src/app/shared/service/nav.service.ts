...
export class NavService {
  ...
  MENUITEMS: Menu[] = [
   ...
   // MENUIsTEMS: Menu[] = [
   //    { path: '/neden', title: 'Neden Aşkım', type: 'link' },
   //    { path: '/nasil', title: 'Nasıl Aşkım', type: 'link' },
   //    { path: '/destek', title: 'Destek', type: 'link' },
   //    { path: '/İletişim', title: 'Neden Aşkım', type: 'link' },
   
   // ];
   MENUIsTEMS: Menu[] = [
   ];
  	// Array
	items = new BehaviorSubject<Menu[]>(this.MENUIsTEMS);
